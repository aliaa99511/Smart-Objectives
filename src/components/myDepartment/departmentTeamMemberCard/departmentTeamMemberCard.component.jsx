...
import styles from "./departmentTeamMemberCard.module.css";
...
const DepartmentTeamMemberCard = ({ member, department }) => {
  ...
  const handleCurrentObjectives = () => {
    navigate(`/myDepartment/currentObjectives?departmentId=${department.id}`, {
      state: {
...
export default DepartmentTeamMemberCard;
